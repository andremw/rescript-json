...
Zora$1.test("encode tests", (function (t) {
        ...
        t.test("should encode a tuple of (string, float)", (function (t) {
                t.equal(Json__Encode.encode(Json__Encode.tuple2([
                              "a_string",
                              14.5
                            ], Json__Encode.string, Json__Encode.$$float), 0), "[\"a_string\",14.5]", "Should equal");
                return Zora.done(undefined);
              }));
        t.test("should encode a tuple of (array, object)", (function (t) {
                var arr = [
                  1,
                  2,
                  3
                ...
                var arr_encode = function (arr) {
                  return Json__Encode.array(arr, Json__Encode.$$int);
                };
                var obj_encode = function (obj) {
                  return Json__Encode.object([
                              [
                                "key1",
                                Json__Encode.$$int(obj.key1)
                              ],
                              [
                                "key2",
                                Json__Encode.string(obj.key2)
                              ]
                            ]);
                };
                var tuple = [
                ...
                t.equal(Json__Encode.encode(Json__Encode.tuple2(tuple, arr_encode, obj_encode), 0), "[[1,2,3],{\"key1\":1,\"key2\":\"ok\"}]", "Should equal");
                return Zora.done(undefined);
              }));
        return Zora.done(undefined);
      }));
